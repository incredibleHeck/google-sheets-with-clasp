...
function callGeminiBatchAPI(textArray, model, key, retryCount = 0) {
  ...
  const prompt = `
    ...
    Your task for each string: 
    1. Fix all grammar, spelling, and punctuation errors. 
    2. Improve the sentence flow and clarity slightly, but **do not** change the tone to be overly formal. 
    3. Keep the original meaning exactly the same. 
    4. Return ONLY a valid JSON Array of strings. 
    5. The output array MUST have exactly the same number of items as the input array.
